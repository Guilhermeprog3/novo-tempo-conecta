// guilhermeprog3/novo-tempo-conecta/app/mapa/page.tsx
"use client"
        ...
        <div className="w-full lg:w-1/3 border-r bg-card overflow-y-auto bg-gradient-to-r from-[#1E3A8A] to-[#254A9E] text-white">
          <div className="p-6">
            ...
            <div className="space-y-4 mb-6">
              ...
              <Button variant="outline" className="w-full bg-transparent text-white" onClick={() => setShowFilters(!showFilters)}>
                Filtros <ChevronDown className="ml-auto w-4 h-4" />
              </Button>
              {showFilters && (
                <Card className="p-4 bg-white/10 border-none text-white">
            ...
            <div className="space-y-4">
              {loading ? <Loader2 className="animate-spin mx-auto" /> : sortedEstablishments.map((est) => (
                <Card key={est.id} className="text-black p-4">
