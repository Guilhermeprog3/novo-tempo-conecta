...
import { Search, Download, Trash2, Loader2, Store, Globe, Filter, X, MapPin } from "lucide-react"
...
export default function AdminEmpresasPage() {
    ...
    const exportToCSV = () => {
        const headers = ["Nome", "Categoria", "Telefone", "Endereço", "Site"];
        const csvContent = [
            headers.join(","),
            ...businesses.map(b => [
                `"${b.businessName}"`,
        ...
        link.download = "empresas_novo_tempo.csv";
        link.click();
    };
    ...
    const getCategoryStyle = (category: string) => {
        // Lógica simples para cores de badge baseada na categoria (pode ser expandida)
                    ...
                    {loading ? (
                        ...
                        <div className="rounded-md">
                            <Table>
                                ...
                                <TableBody>
                                    {filtered.length === 0 ? (
                                        <TableRow><TableCell colSpan={5} className="text-center py-12 text-slate-500">Nenhuma empresa encontrada.</TableCell></TableRow> 
                                    ) : (
                                        filtered.map(b => (
