...
import { Menu, X, User, Settings, LogOut, Heart, Star, ChevronDown } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
            ...
            {!isMounted ? (
              ...
              <DropdownMenu modal={false}>
                ...
                >
                  ...
                  <DropdownMenuItem asChild>
                    <Link href="/usuario/favoritos" className="hdr-dropdown-item">
                      <Heart size={14} /> Favoritos
                    </Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href="/usuario/avaliacoes" className="hdr-dropdown-item">
