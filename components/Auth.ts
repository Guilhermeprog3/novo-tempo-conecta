...
.auth-section-label {
  ...
  text-transform: uppercase; color: rgba(0,204,255,0.65);
...
.auth-field-err {
  font-size: 0.71rem; color: #fca5a5; margin-top: 5px;
  display: flex; align-items: center; gap: 4px;
}

/* ── GRID ── */
.auth-form-grid { display: grid; gap: 1rem; }
.auth-form-grid.cols2 { grid-template-columns: 1fr 1fr; }
...
.auth-error {
  ...
  font-size: 0.82rem; color: #fca5a5; line-height: 1.4;
}
...
/* ── SECTION DIVIDER ── */
.auth-sep { height: 1px; background: rgba(255,255,255,0.06); margin: 1.8rem 0; }
...
.srch-sidebar {
  ...
  background: #fff; border-right: 1px solid #f0ece5;
...
.srch-card {
  ...
  box-shadow: 0 2px 14px rgba(0,34,64,0.07);
  border: 1px solid #f0ece5; text-decoration: none; color: inherit;
